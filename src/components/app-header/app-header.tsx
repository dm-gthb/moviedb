...
import { MovieSearchForm } from '../movies/movie-search-form/movie-search-form';
  ...
  return (
    <div className="relative">
      <header className="mx-auto max-w-7xl px-8">
        ...
        <div
          className={`absolute left-[50%] z-50 w-full translate-x-[-50%] bg-white pb-16 pt-2 shadow-md dark:bg-gray-950 ${isSearchPanel ? 'visible' : 'collapse'}`}
        >
          <MovieSearchForm onSubmit={handleSearchFormSubmit} inputRef={searchInputRef} />
        </div>
      </header>
    </div>
  );
